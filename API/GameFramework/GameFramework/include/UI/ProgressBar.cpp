...
void CProgressBar::SetTexture(const std::string& Name, const std::vector<std::wstring>& vecFileName, const std::string& PathName)
{
...
void CProgressBar::SetTextureColorKey(unsigned char r, unsigned g, unsigned char b, int Index)
{
	if (m_Texture)
	{
